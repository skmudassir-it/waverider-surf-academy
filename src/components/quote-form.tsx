...
const quoteSchema = z.object({
  ...
  service: z.string().min(1, "Choose a lesson"),
...
export function QuoteForm() {
  ...
  const onSubmit = async (values: QuoteFormValues) => {
    ...
    try {
      ...
      toast.error("Network error", { description: "Please try again or call (555) 014-2233." });
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="qf-service">Lesson of interest</Label>
          <Select
            value={undefined}
      ...
      <div className="space-y-2">
        <Label htmlFor="qf-message">Your experience level</Label>
        <Textarea
          id="qf-message"
          rows={5}
          placeholder="First time in the water? Tell us about your goals and any dates that work for you…"
          {...register("message")}
      ...
      <Button type="submit" size="lg" className="btn-gradient w-full rounded-full" disabled={submitting}>
        ...
        {submitting ? "Sending…" : "Book My Lesson"}
      </Button>
