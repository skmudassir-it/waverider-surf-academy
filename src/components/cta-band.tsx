...
export function CtaBand({
  title = "Ready to catch your first wave?",
  subtitle = "Book a lesson today — boards, wetsuits and stoke included. Golden-hour slots fill fast, so grab yours now.",
      ...
      <Reveal className="mx-auto max-w-6xl">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          <div className="absolute inset-0 -z-10">
            <Image
              src={image}
              alt="Golden-hour surf rolling in at a Santa Cruz beach"
              fill
              sizes="100vw"
