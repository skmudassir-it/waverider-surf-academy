...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Beginner surf lessons, private coaching, group surf camps, advanced technique clinics, kids surf school, surf fitness & safety and corporate team surf days in Santa Cruz, California.",
};
    ...
    <>
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            eyebrow="Our lessons"
            title="Seven ways to catch the wave"
            subtitle="From your first whitewater ride to contest-ready turns — every session includes coaching, gear and a video review."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-10 sm:py-14">
        <div className="mx-auto max-w-6xl">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-accent">
                      Lesson details <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" />
                    </span>
                  </div>
                </Link>
              </StaggerItem>
          ...
          <Reveal className="mt-14 text-center">
            <p className="text-muted-foreground">Not sure which lesson fits you?</p>
            <Link
              href="/contact"
              className={cn(buttonVariants({ size: "lg" }), "btn-gradient mt-4 rounded-full")}
            >
              Talk to a surf coach <ArrowRight className="size-4" />
            </Link>
          </Reveal>
        </div>
      </section>
