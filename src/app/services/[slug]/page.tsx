...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${service.name} | WaveRider Surf Academy`,
      description: service.description,
  ...
  return (
    <>
          ...
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/contact" className={cn(buttonVariants({ size: "lg" }), "btn-gradient rounded-full")}>
                Book This Lesson <ArrowRight className="size-4" />
              </Link>
              <Link
      ...
      <section className="px-4 py-14 sm:py-16">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_20rem]">
          ...
          <div className="space-y-6">
            <Reveal delay={0.05}>
              <div className="glass-card rounded-3xl p-7">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Every student is different. Tell us your experience level and we will match you
                  with the right lesson, break and coach.
                </p>
                <Link
                  href="/contact"
            ...
            <Reveal delay={0.1}>
              <div className="glass-card rounded-3xl p-7">
                <h3 className="font-display text-base font-bold text-foreground">Where we surf</h3>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  Lessons run at Cowell Beach, Pleasure Point, Capitola and 26th Avenue — we pick
                  the break that suits the day’s swell, tide and your level. All beaches are within
                  a 15-minute drive of our Santa Cruz base at 1420 Pacific Coast Highway.
                </p>
              </div>
            </Reveal>
          </div>
              ...
              <StaggerItem key={s.slug} className="h-full">
                ...
                >
                  ...
                  <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-accent">
                    View lesson <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" />
                  </span>
                </Link>
              </StaggerItem>
            ))}
      ...
      <CtaBand
        ...
        subtitle="Tell us about your experience level and we will respond within one business day with a booking and a firm price."
      />
    </>
  );
}
