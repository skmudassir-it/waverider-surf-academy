...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Stories from WaveRider Surf Academy: summer grom camps, contest preparation and community surf days across the Santa Cruz coastline.",
};
    ...
    <>
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="Groms, contests and community"
            subtitle="A few recent highlights that show how we think — safety first, stoke always, and the ocean treated like home."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-12">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            eyebrow="Your story"
            title="The next session could be yours"
            subtitle="Whether you are booking a first lesson or a 60-person corporate day, we would love to get you in the water."
          />
          <Stagger className="mt-10 grid gap-6 sm:grid-cols-3" stagger={0.08}>
            {[
              { k: "1", v: "Tell us your experience level — we reply within one business day." },
              { k: "2", v: "We match you with the right lesson, break and coach for the conditions." },
              { k: "3", v: "You suit up, catch waves, and leave with video, photos and a smile." },
            ].map((s) => (
              <StaggerItem key={s.k}>
          ...
          <Reveal className="mt-10 text-center">
            ...
            >
              Start your surf story <ArrowRight className="size-5" />
            </a>
          </Reveal>
        </div>
      </section>
